import styles from './AdImageCard.module.scss';
import roxLogoUrl from '../../assets/brand/rox.png';

export function AdImageCard({
  title,
  publishedAt,
  imageUrl,
}: {
    ...
    <div className={styles.card} style={{ backgroundImage: `url(${imageUrl})` }}>
      ...
      <div className={styles.grid}>
        <div className={styles.header}>
          <div className={styles.category}>Реклама</div>
          <img className={styles.badge} src={roxLogoUrl} alt="rox" />
        </div>
